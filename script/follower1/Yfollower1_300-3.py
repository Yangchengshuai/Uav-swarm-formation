...
class Follower_uav(object):
    ...
    def __init__(self, num=3, uavid=1):
        ...
        self.origin_formation = formation_dict["line"][0]  #是一个三维数组
    ...
    def receive_cmd(self):
        ...
        while True:
            ...
            self.cmd_leader_avoid = self.str2Array(data)  #转换为二维数组
    ...
    def target_formation(self):
        ...
        self.cmd_vel_enu.twist.linear.x = self.Kp * ((self.leaderPose[0] + self.origin_formation[0] - startPosition["follower1"][0] - self.pose.pose.position.x))
        self.cmd_vel_enu.twist.linear.y = self.Kp * ((self.leaderPose[1] + self.origin_formation[1] - startPosition["follower1"][1] - self.pose.pose.position.y))
        self.cmd_vel_enu.twist.linear.z = self.Kp * ((self.leaderPose[2] + self.origin_formation[2] - startPosition["follower1"][2] - self.pose.pose.position.z))
